...
def main():
	...
	parser.epilog = "Usage: .py -t 10.20.30.40 -p 8080 -c 1"
	...
	if args.target is not None:
		if args.port is not None:
			if args.count is None:
				print('ALERT You did not use --counter/-c parameter, so 1 packet will be sent..')
   ...
   @&&&&&&&&@&@&&&&&&&&&&&@@@@@@@@@@@@@@@@@@@@@@&@@@@@@@@@@@@@@@@@@@@@@&@&&&&&&&@@@@&&&&&&&&&&&&&&
   &&&&&&&&@&&&&&&&&&&&&&&&@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&&&&&&&@@@@@@@@@@&&@@&&&&&&&&&&&&&&&                                                                                                                                              
                      _      _____ _____   _____ _____  ______ _____ _____ 
                     | |    |  ___|_   _| |_   _|_   _| |  _  \_   _|  ___|
                     | |    | |__   | |     | |   | |   | | | | | | | |__  
                     | |    |  __|  | |     | |   | |   | | | | | | |  __| 
                     | |____| |___  | |    _| |_  | |   | |/ / _| |_| |___ 
                     \_____/\____/  \_/    \___/  \_/   |___/  \___/\____/                                                                                                            
===================================================================================================   
			usage: LetItDie.py [-h HELP] [--target TARGET] [--port PORT]
                           [--count COUNT] [--version]
optional arguments:
